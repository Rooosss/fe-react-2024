...
const Header: React.FC<HeaderProps> = ({ onShowAbout, onShowProducts, showTheme }) => (
            ...
            <div className={styles.header__inner}>
                <div className={styles.header__logo_wrapper}>
                    ...
                    <div className={styles.header__theme}>
                        <button className={styles.header__theme_button_light} onClick={showTheme}>
                        ...
                        <button className={styles.header__theme_button_dark} onClick={showTheme}>
                            <svg width="30" height="34" viewBox="0 0 30 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
